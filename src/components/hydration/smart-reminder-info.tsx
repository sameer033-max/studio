    ...
    <Card className="shadow-lg w-full bg-secondary/50">
      ...
      <CardContent>
        <p className="text-sm text-muted-foreground">
          This section is a placeholder for future smart reminder features, such as AI-powered suggestions for when to drink. In a full mobile app experience, you would typically be able to set custom reminders. For now, remember to take regular sips throughout the day. You can use your phone's built-in reminder app to set hydration alerts.
        </p>
